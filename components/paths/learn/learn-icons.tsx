...
export function FileIcon({
  ...
  const colorMap: Record<
    FileKind,
    { body: string; accent: string; line: string }
  > = {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M10 6H28L34 12H38C40.21 12 42 13.79 42 16V16H6V10C6 7.79 7.79 6 10 6Z"
        fill={c.accent}
        opacity="0.6"
      />
      <path
...
export function NavIcon({ id, className }: { id: string; className?: string }) {
  ...
  const folderIcons: Record<string, ReactElement> = {
    ...
    knowledge: (
      ...
      >
        <path
          d="M4 4h6v7H4V4zM14 4h6v7h-6V4zM4 13h6v7H4v-7zM14 13h6v7h-6v-7z"
          opacity="0.8"
        />
    ...
    lab: (
      ...
      >
        <path
          d="M9 3h6v6l5 8.5a2 2 0 01-1.7 3H5.7a2 2 0 01-1.7-3L9 9V3z"
          fill="#0078D4"
          fillOpacity="0.15"
        />
        <path d="M9 3h6" />
    ...
    apps: (
      <svg
        ...
        aria-hidden="true"
      >
        <rect x="3" y="3" width="7" height="7" rx="2" fill="#E2B974" />
        <rect x="14" y="3" width="7" height="7" rx="2" fill="#78B8C6" />
        <rect
          x="3"
          y="14"
          width="7"
    ...
    "obsidian-vault": (
      ...
      >
        <path
          ...
          strokeWidth="1.5"
        />
        <circle cx="8" cy="9" r="1.4" fill="#E2B974" />
        <circle cx="15.5" cy="8" r="1.4" fill="#E2B974" />
        <circle cx="12" cy="15.5" r="1.4" fill="#E2B974" />
        <path
          d="m9.2 9.5 2.1 4.7m3.2-5-1.8 5.1M9.3 9h4.8"
          stroke="#9FD0DA"
          strokeWidth="1.1"
        />
      </svg>
...
const appIconFiles: Record<string, string> = {
  "app-antigravity": "/learn/apps/antigravity.png",
  "app-opencode": "/learn/apps/opencode.png",
  "app-notebooklm": "/learn/apps/notebooklm.svg",
  "app-vscode": "/learn/apps/vscode.svg",
  "app-obsidian": "/learn/apps/obsidian.svg",
  "app-hermes": "/learn/apps/hermes.png",
...
export function AppIcon({
  ...
  if (src) {
    const needsLightTile =
      app.id === "app-opencode" || app.id === "app-notebooklm";
    return (
      ...
      <img
        ...
        style={{
          ...
          padding: needsLightTile ? Math.max(4, size * 0.1) : undefined,
          borderRadius: needsLightTile ? "22%" : undefined,
          background: needsLightTile ? "#f4f2ed" : undefined,
        }}
      />
    );
  }
  const palette = {
    "app-antigravity": ["#24404B", "#9FD0DA"],
    "app-opencode": ["#30291F", "#F3D195"],
    "app-notebooklm": ["#23334B", "#A8C7FA"],
    "app-hermes": ["#33233E", "#D4B3E8"],
  }[app.id] ?? ["#202A32", "#E2B974"];
  return (
    <svg
      className={className}
      width={size}
